...
(function () {
  ...
  const VIEWER_CSS = 'https://the-dump-bin.com/shared/pdf-viewer/materials-pdf-viewer.css?v=1.1.3';
  const VIEWER_SRC = 'https://the-dump-bin.com/shared/pdf-viewer/materials-pdf-viewer.js?v=1.1.3';

/* Native BarcodeDetector + html5-qrcode fallback. All common retail formats. 3.3.101 */
(function (global) {
  'use strict';
  ...
  const HTML5_SRC = `js/vendor/html5-qrcode.min.js?v=${encodeURIComponent(global.EOD_APP_VERSION || '3.3.89')}`;

...
export function checklanesRoot(): string {
...
export function buildPrompt(scenario: Scenario): string {
...
export function playwrightMcpServers(): Record<string, { command: string; args: string[] }> {
  return {
    playwright: {
      command: 'npx',
